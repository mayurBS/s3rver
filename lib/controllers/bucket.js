    ...
    ctx.body = {
      ListBucketResult: {
        ...
        Contents: result.objects.map(object => {
          console.log("ctx.query['OptionalObjectAttributes']===========",ctx.query['OptionalObjectAttributes'])
          return {
            Key: object.fullPath,
            LastModified: object.modTime.toISOString(),
            ETag: object.checksum,
            Size: object.size,
            inCache: object.inCache,
            // ONTARGET: object.onTarget,
